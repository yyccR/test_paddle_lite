...
//        std::string cls_model_file("/Users/yang/CLionProjects/test_paddle_lite/paddle_ocr/v4/ch_ppocr_mobile_v2.0_cls_opt.nb");
        predictor_crnn= loadModel(rec_model_file, 1);
//        auto cls_predictor = loadModel(cls_model_file, 1);
...
//        file_name += std::to_string(i) + "_crop_img.jpg";
...
//        std::string file_name("/Users/yang/CLionProjects/test_paddle_lite/data/images/");
//        file_name += std::to_string(i) + "_resize_img.jpg";
...
//        auto inference_start = std::chrono::steady_clock::now();
        ...
        predictor_crnn.reset();
//        std::cout << "predictor_crnn->GetVersion(): " << predictor_crnn->GetVersion() << std::endl;
//        input_tensor0.release();
//        output_tensor0.release();
...
void test_paddle_ocr_v4_paddle_lite(){
...
//    cv::glob(img_dir, cv_all_img_names);
    ...
    auto det_predictor = loadModel(det_model_file, 2);
    auto rec_predictor = loadModel(rec_model_file, 4);
    auto cls_predictor = loadModel(cls_model_file, 4);
